...
#ifndef vtkCircleWidget_h
#define vtkCircleWidget_h

#define vtkInteractionWidgets_EXPORTS
#include "vtkInteractionWidgetsModule.h" // For export macro
#include "vtkAbstractWidget.h"

class vtkCircleRepresentation;
class vtkHandleWidget;
class vtkCircleWidgetCallback; 


class VTKINTERACTIONWIDGETS_EXPORT vtkCircleWidget : public vtkAbstractWidget
//class  vtkCircleWidget : public vtkAbstractWidget
{
public:
  // Description:
  // Instantiate this class.
	static vtkCircleWidget *New();

  // Description:
  // Standard methods for a VTK class.
	vtkTypeMacro(vtkCircleWidget, vtkAbstractWidget);
  ...
  void SetRepresentation( vtkCircleRepresentation *r );
  /*  {this->Superclass::SetWidgetRepresentation(
      reinterpret_cast<vtkWidgetRepresentation*>(r));}*/

  // Description:
  // Return the representation as a vtkDistanceRepresentation.
  vtkCircleRepresentation *GetCircleRepresentation( );
    /*{return reinterpret_cast<vtkCircleRepresentation*>(this->WidgetRep);}*/
  ...
  void SetCircleWorldPoint( float fCenter[ 3 ] , float fRadius );
...
protected:
  ...
  vtkCircleWidgetCallback *CircleWidgetCallback1;
  vtkCircleWidgetCallback *CircleWidgetCallback2;

  vtkHandleWidget *Point3Widget;
  vtkHandleWidget *Point4Widget;
  vtkCircleWidgetCallback *CircleWidgetCallback3;
  vtkCircleWidgetCallback *CircleWidgetCallback4;
  vtkHandleWidget *LineWidget;
  vtkCircleWidgetCallback *LineCallback;
  // Methods invoked when the handles at the
  // end points of the widget are manipulated
  void StartCircleInteraction(int handleNum);
  void CircleInteraction(int handleNum);
  void EndCircleInteraction(int handleNum);
  double LinePos[3];   
  double CircleCenter[ 3 ];
  bool bRotateEnable;
  bool bLineResize;
//BTX
  friend class vtkCircleWidgetCallback; 
//ETX

private:
	vtkCircleWidget(const vtkCircleWidget&);  //Not implemented
	void operator=(const vtkCircleWidget&);  //Not implemented
};
