...
#ifndef vtkRectRepresentation_h
#define vtkRectRepresentation_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkRectRepresentation : public vtkWidgetRepresentation
//class vtkRectRepresentation : public vtkWidgetRepresentation
{
public:
  // Description:
  // Standard VTK methods.	
  vtkTypeMacro(vtkRectRepresentation, vtkWidgetRepresentation);
...
//BTX -- used to communicate about the state of the representation
  enum { Outside = 0 , NearP1 , NearP2 , NearP3 , NearP4 , OnLine12 , OnLine23 , OnLine34 , OnLine14 , NearRotateLine , InsideRect };
//ETX
...
private:
	vtkRectRepresentation(const vtkRectRepresentation&);  //Not implemented
	void operator=(const vtkRectRepresentation&);  //Not implemented
};
