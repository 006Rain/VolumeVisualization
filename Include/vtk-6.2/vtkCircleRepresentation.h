...
#ifndef vtkCircleRepresentation_h
#define vtkCircleRepresentation_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkCircleRepresentation : public vtkWidgetRepresentation
//class vtkCircleRepresentation : public vtkWidgetRepresentation
{
public:
  // Description:
  // Standard VTK methods.	
  vtkTypeMacro(vtkCircleRepresentation, vtkWidgetRepresentation);
  ...
  virtual void GetPoint3WorldPosition(double pos[3]) = 0;
  virtual void GetPoint4WorldPosition(double pos[3]) = 0;
  virtual double* GetPoint3WorldPosition() = 0;
  virtual double* GetPoint4WorldPosition() = 0;
  virtual void SetPoint3DisplayPosition(double pos[3]) = 0;
  virtual void SetPoint4DisplayPosition(double pos[3]) = 0;
  virtual void GetPoint3DisplayPosition(double pos[3]) = 0;
  virtual void GetPoint4DisplayPosition(double pos[3]) = 0;
  virtual void SetPoint3WorldPosition(double pos[3]) = 0;
  virtual void SetPoint4WorldPosition(double pos[3]) = 0;

  virtual void SetLineWorldPosition(double pos[3]) = 0;
  virtual void GetLineWorldPosition(double pos[3]) = 0;
  virtual void SetLineDisplayPosition(double pos[3]) = 0;
  virtual void GetLineDisplayPosition(double pos[3]) = 0;
  // Description:
  ...
  vtkGetObjectMacro(LineHandleRepresentation, vtkHandleRepresentation);
  // Description:
...
//BTX -- used to communicate about the state of the representation
  enum { Outside = 0 , NearP1 , NearP2 , NearP3 , NearP4 , OnLine12 , OnLine23 , OnLine34 , OnLine14 , NearRotateLine , InsideCircle };
//ETX
...
protected:
  ...
  vtkHandleRepresentation *LineHandleRepresentation;
...
private:
	vtkCircleRepresentation(const vtkCircleRepresentation&);  //Not implemented
	void operator=(const vtkCircleRepresentation&);  //Not implemented
};
